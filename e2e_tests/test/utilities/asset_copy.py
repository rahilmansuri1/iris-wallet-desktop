...
def copy_rgb25_image_to_home_directory(current_working_directory):
    """
    Copies the rgb25.png image from the e2e_tests/assets directory to the home directory.
    ...
    image_path_in_home = home_directory / 'rgb25.png'
